...
exec { 'Add_header':
    ...
    sudo sed -i "/server_name _/a \\\\\trewrite ^/redirect_me https://www.youtube.com/watch?v=QH2-TGUlwu4 permanent;" /etc/nginx/sites-enabled/default; sed -i "/rewrite/a \\\\\terror_page 404 /error404.html;" /etc/nginx/sites-enabled/default;
